<x-layout>
    <ol
        ...
        <li class="flex items-center">
            <a class="hover:underline hover:text-blue-500" href="{{ route('materials') }}">List Materi</a>
    ...
    <section class="bg-white dark:bg-gray-900 border border-gray-200">
        <div class="py-8 mb-4` px-4 mx-auto max-w-2xl lg:py-16">
            <h2 class="mb-4 text-xl text-center font-bold text-gray-900 dark:text-white">Tambah Materi</h2>
